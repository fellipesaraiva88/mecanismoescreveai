...
CREATE INDEX IF NOT EXISTS idx_messages_conversation ON messages(conversation_jid);
...
CREATE INDEX IF NOT EXISTS idx_conversations_instance ON conversations(instance);
...
CREATE INDEX IF NOT EXISTS idx_participants_instance ON participants(instance);
...
CREATE INDEX IF NOT EXISTS idx_behavioral_participant ON behavioral_analysis(participant_jid);
CREATE INDEX IF NOT EXISTS idx_behavioral_conversation ON behavioral_analysis(conversation_jid);
CREATE INDEX IF NOT EXISTS idx_behavioral_date ON behavioral_analysis(analysis_date);
...
CREATE INDEX IF NOT EXISTS idx_insights_conversation ON ai_insights(conversation_jid);
CREATE INDEX IF NOT EXISTS idx_insights_participant ON ai_insights(participant_jid);
...
CREATE INDEX IF NOT EXISTS idx_interactions_from ON interaction_graph(from_participant_jid);
CREATE INDEX IF NOT EXISTS idx_interactions_to ON interaction_graph(to_participant_jid);
CREATE INDEX IF NOT EXISTS idx_interactions_conversation ON interaction_graph(conversation_jid);
